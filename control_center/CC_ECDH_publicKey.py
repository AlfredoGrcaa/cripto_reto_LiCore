...
# Generate private and public key for Party A
privKeyA = random.randint(1, N-1)
xPublicKeyA, yPublicKeyA = EccMultiply(Gx, Gy, privKeyA % N)

# Share the public key of Party A with Party B
sharedPublicKeyA = (xPublicKeyA, yPublicKeyA)

print("Private key of Party A: ", privKeyA)

print("Shared public key of Party A: ", sharedPublicKeyA)