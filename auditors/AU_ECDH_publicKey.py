...
# Generate private and public key for Party B
privKeyB = random.randint(1, N-1)
xPublicKeyB, yPublicKeyB = EccMultiply(Gx, Gy, privKeyB % N)

# Share the public key of Party B with Party A
sharedPublicKeyB = (xPublicKeyB, yPublicKeyB)

print("Private key of Party B: ", privKeyB)

print("Public key of Party B: ", sharedPublicKeyB)